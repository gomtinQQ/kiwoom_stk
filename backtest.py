...
# Create a Stratey
class Strategy_ma5_ma20(bt.Strategy):
...
class Strategy_ma5_ma20_highvolume(bt.Strategy):
...
if __name__ == '__main__':
    ...
    for code in listcode:
        ...
        cerebro.optstrategy(Strategy_ma5_ma20_highvolume, maperiod5=range(5,10), maperiod20=range(10, 50), code=code, strfilename=strfilename)
